...
func _ready() -> void:
	...
	level_scence_name=get_parent().name

func save_node_data()->void:
	var nodes=get_tree().get_nodes_in_group("save_data_componet")
...
func save_game()->void:
	...
	var level_save_file_name:String=save_file_name % level_scence_name
