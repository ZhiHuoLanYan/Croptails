extends Control
@onready var day_label: Label = $DayPenel/MarginContainer/DayLabel
...
func _on_normal_speed_button_pressed() -> void:
	DayAndNightCycleManager.game_speed=normal_speed # Replace with function body.


func _on_fest_speed_button_pressed() -> void:
